...
import 'clsx';
import { b as getallactiviteBydate } from '../chunks/backend_IUuohMDK.mjs';
...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, {}, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section class=" mx-auto bg-[#282828] text-white p-6"> <div class="bg-[#212121] program-item mb-6"> <a href="/activite" class="block"> <img src="/src/assets/img/projection.jpg" alt="Projection" class="w-220 mx-auto"> <h2 class="font-alegreya text-[24px]  text-center mt-2">Projection</h2> </a> <p class="font-ad text-[16px] text-[#ccc] leading-[1.5] m-3">
...
}, "C:/Users/mmi/Documents/MMI/MMI1/SAE/SAE-203/sae-203-2025-ethdm/src/pages/activite/index.astro", void 0);

const $$file = "C:/Users/mmi/Documents/MMI/MMI1/SAE/SAE-203/sae-203-2025-ethdm/src/pages/activite/index.astro";
const $$url = "/activite";
